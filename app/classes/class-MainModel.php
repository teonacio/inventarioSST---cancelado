...
{
	/**
	 * $form_data - Dados de formulários de envio
	 *
	 * @access public
	 */	
	public $form_data;
	...
	/**
	 * $form_msg - Mensagens de feedback para formulários
	 *
	 * @access public
	 */	
	public $form_msg;
	...
	/**
	 * $form_confirma - Mensagem de confirmação para apagar dados de formulários
	 *
	 * @access public
	 */
	...
	/**
	 * $db - Objeto de conexão PDO
	 *
	 */
	public $db;

	/**
	 * $controller - Controller que gerou esse modelo
	 *
	 * @access public
	 */
	public $controller;
	...
	/**
	 * Inverte datas - Obtém a data e inverte seu valor (De: d-m-Y H:i:s para Y-m-d H:i:s ou vice-versa.)
	 *
	 * @access public
